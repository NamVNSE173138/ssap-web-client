...
const Footer = () => {
  return (
    <footer className="flex flex-col justify-between px-8 pt-8" style={{backgroundColor:"#71709D"}}>
      <div className="relative">
        <div className="absolute grid grid-rows-1 grid-cols-4 ">
        <div className="col-span-2 text-lg">
                    <Logo/>
                    <div className='opacity-70'>
                        <p className="w-[45%] p-10 text-white">Get a full control of debts in the dsu digital world simple labore et dolore ma</p>
                        <p></p>
                        <p></p>
                    </div>
                ...
                <div className="mt-16 basis-1/2 md:mt-0">
                    ...
                    <menu className="flex flex-col gap-1.5 text-[16px] text-white">
                ...
                <div className="mt-16 basis-1/4 md:mt-0">
                    <p className="mt-9 mb-4 font-semibold text-[30px]">GET IN TOUCH</p>
                    <menu className="flex flex-col gap-1.5 text-[16px] text-white">
                        <li className='hover:underline'>
        ...
        <div className="flex items-center gap-2 py-6 border-t border-gray-400 basis-1/4  ">
                <p className="text-lg opacity-70">FOLLOW US</p>
