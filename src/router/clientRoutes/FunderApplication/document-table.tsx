          ...
          {(documents && documents.length > 0) && (
            documents.map((doc: any) => (
              ...
              >
                ...
                <div style={{ flex: 1, textTransform: 'capitalize' }}>{doc.type}</div>
                <div style={{ flex: 1 }}>
                ...
                <div style={{ flex: 1 }}>
                  <Tooltip title={`Uploaded on ${new Date(doc.createdAt).toLocaleDateString('en-US')}`}>
                    <span style={{ display: 'flex', alignItems: 'center' }}>
                      <TimeIcon style={{ verticalAlign: 'middle', marginRight: '8px', color: '#0d47a1' }} />
