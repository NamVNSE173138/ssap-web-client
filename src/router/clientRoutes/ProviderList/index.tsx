  ...
  const renderProviders = () => (
    <div className="space-y-6 bg-gray-100 p-6 rounded-lg shadow-xl">
      <div className="flex items-center justify-center mb-6">
        <h2 className="flex items-center text-3xl font-semibold text-gray-800 bg-gradient-to-r from-cyan-500 to-blue-500 p-4 rounded-lg shadow-xl">
      ...
      <div className="flex justify-center">
        <div className="space-y-4 w-4/5">
          ...
          {providers.map((provider, index) => (
            <div
              key={provider.id}
              className="flex justify-between items-center p-4 bg-white border border-gray-200 rounded-lg shadow-md hover:shadow-lg hover:scale-105 transform transition duration-300"
            >
              <p className="w-1/12 text-center text-gray-800">{index + 1}</p>
              <p className="w-3/12 text-gray-800">{provider.username}</p>
