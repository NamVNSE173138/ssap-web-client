...
const ListFundersCard = () => {
  ...
  const fetchProviders = async () => {
    try {
      ...
      setProviders(
        response.filter((provider: any) => provider.roleName == "Funder")
      );
    } catch (error) {
  ...
  return (
    <div className="col-span-12 rounded-sm border border-stroke bg-white py-6 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
      ...
      <Paper
        elevation={3}
        style={{ marginBottom: "10px", padding: "20px", borderRadius: "10px" }}
      >
...
export default ListFundersCard;
