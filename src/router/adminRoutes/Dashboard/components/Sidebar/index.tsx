          ...
          <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
            ...
            <div>
              ...
              <ul className="mb-6 flex flex-col gap-1.5">
                ...
                <li>
                  <NavLink
                    to="/admin/account-awaiting-approval"
                ...
                <li>
                  <NavLink
                    to="/admin/scholarship-awaiting-approval"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('scholarship-awaiting-approval') && 'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <svg
                      className="fill-current"
                    ...
                    >
                      <path
                        d="M21 4H7C5.34315 4 4 5.34315 4 7V17C4 18.6569 5.34315 20 7 20H21C21.5523 20 22 19.5523 22 19V5C22 4.44772 21.5523 4 21 4ZM20 18H7C6.44772 18 6 17.5523 6 17V7C6 6.44772 6.44772 6 7 6H20V18ZM9 8H17V10H9V8ZM9 12H14V14H9V12Z"
                        fill="currentColor"
                      />
                      <path
                        d="M3 6H2C1.44772 6 1 6.44772 1 7V19C1 20.6569 2.34315 22 4 22H18C18.5523 22 19 21.5523 19 21H4C3.44772 21 3 20.5523 3 20V6Z"
                        fill="currentColor"
                      />
                    </svg>
