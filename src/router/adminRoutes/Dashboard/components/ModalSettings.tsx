...
//   const fields=Object.keys(Object.values(dataJSON)[0] as any).filter((item:any)=>!(item.startsWith("delta_")));
...
//         else{
//         if (key=='id'){
//           if (!(Object.keys(dataJSON).includes(value as any)||value=="ALL")){
