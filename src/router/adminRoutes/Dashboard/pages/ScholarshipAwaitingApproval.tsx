...
import { CircularProgress, Button, Input, Paper } from "@mui/material";
...
import {
  NotifyFunderScholarshipAcceptance,
  NotifyFunderScholarshipRejection,
...
const ScholarshipAwaitingApproval = () => {
  ...
  const [rejectedScholarship, setRejectedScholarship] =
    useState<ScholarshipProgramType | null>(null);
  ...
  const handleSendRejectionEmail = async () => {
    ...
    setLoading(true);
    try {
      const scholarshipId = rejectedScholarship?.id
        ? Number(rejectedScholarship.id)
        : 0;
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-6 rounded-lg shadow-lg w-96">
        ...
        <div className="mt-4 flex justify-between space-x-4">
          ...
          <Button
            onClick={() => setRejectedScholarship(null)}
        ...
        .map((scholarship) => (
          ...
          >
            ...
            <div style={{ flex: 2.5, marginRight: "20px" }}>
              {scholarship.description.length > 12
                ? scholarship.description.slice(0, 12) + ".."
            ...
            {/* Amount */}
            <div style={{ flex: 1, marginRight: "20px" }}>
              ${scholarship.scholarshipAmount.toLocaleString("en-US")}
            </div>
            {/* Deadline */}
            ...
            {/* University */}
            <div style={{ flex: 2.25, marginRight: "20px" }}>
